      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to your account to manage your feedback forms</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/auth/register" className="text-blue-600 hover:underline focus-ring">
                  Sign up
                </Link>
              </p>
            </div>
